...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { diastolic: @reading.diastolic, heart_rate: @reading.heart_rate, systolic: @reading.systolic }
    end
  ...
  test "should update reading" do
    patch :update, id: @reading, reading: { diastolic: @reading.diastolic, heart_rate: @reading.heart_rate, systolic: @reading.systolic }
    assert_redirected_to reading_path(assigns(:reading))
  end
